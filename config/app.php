...
return [
    ...
    'EmailTransport' => [
        'default' => [
            ...
            //'username' => null,
            //'password' => null,
            'username' => 'postmaster@sandbox2af260bf1f7c47dd8b3e365cb483ad28.mailgun.org',
            'password' => '28439009b5a34c9f2f65ad842d9ab53fManage',			
            'client' => null,
            'tls' => true,
		...
		'mailgun' => [
			...
			'domain' => 'bluejaydev.com', // your domain
			'apiKey' => 'key-096ee6272c0a64ccefbae815687a5c3c' // your api key
		]
    ],
    ...
    'Email' => [
        'default' => [
            'transport' => 'default',
            'from' => 'brad@sandbox2af260bf1f7c47dd8b3e365cb483ad28.mailgun.org',
            /*
